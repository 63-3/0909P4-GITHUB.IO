...
color dayColorForeground=orange1, dayColorHoverover=orange2, dayColorBackground=white;
color darkColorForeground=blue1, darkColorHoverover=blue2, darkColorBackground=grey;
color nightColorForeground=sap, nightColorHoverover=orange3, nightColorBackground=black;
...
void setup()
{
  ...
  if (hour()<=7 || hour()>=17) {
    //night mode}
    appColorForeground  = nightColorForeground;
    appColorHoverover = nightColorHoverover;
    appColorBackground = nightColorHoverover;
  } else if (hour()>7 || hour()<17) {
    //day mode mode
    appColorForeground = dayColorForeground;
    appColorHoverover = dayColorHoverover;
    appColorBackground = nightColorHoverover;
  } else {
    //dark mode
    appColorForeground = darkColorForeground;
...
void draw() {
  ...
  if ( mouseX>musicButtonSquareX && mouseX<musicButtonSquareX+musicButtonSquareWidth && mouseY>musicButtonSquareY && mouseY<musicButtonSquareY+musicButtonSquareHeight ) {
    ...
    quitButtonLneColor =  appColorHoverover;
  } else {
